    ...
    def test_snn_simple_rollout(self):
        ...
        def rollout(S_in, S_target, U1, U2, U3, a1, a2, a3, W1, W2, W3, alpha, beta, rho, thresh):
            ...
            for i in range(seq_len):
                l, U1, U2, U3, a1, a2, a3 = ADALIF_SNN(
                    S_in[i], S_target[i], U1, U2, U3, a1, a2, a3,
        ...
        args = (S_in, S_target, U1, U2, U3, a1, a2, a3, W1, W2, W3,
                alpha, beta, rho, thresh)
        argnums = list(range(2, 15))

        veres = jacve(rollout, order="rev", argnums=argnums)(*args)
        revres = jax.jacrev(rollout, argnums=argnums)(*args)

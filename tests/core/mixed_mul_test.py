...
from utils import assert_optimized_matmul

from graphax.sparse.tensor import DenseDimension, SparseDimension, SparseTensor
...
class TestMixedMul(unittest.TestCase):
    def test_simple_dense_sparse(self):
        ...
        assert_optimized_matmul(stres, res, "pure_dense_rhs", (3, 4))
    ...
    def test_simple_sparse_dense(self):
        ...
        assert_optimized_matmul(stres, res, "pure_dense_lhs", (4, 3))
    ...
    def test_simple_dense_None(self):
        ...
        assert_optimized_matmul(stres, res, "pure_dense_rhs", (3, 3))
    ...
    def test_simple_None_dense(self):
        ...
        assert_optimized_matmul(stres, res, "pure_dense_lhs", (3, 3))
    ...
    def test_3d_sparse_single_contraction(self):
        ...
        assert_optimized_matmul(stres, res, "optimized_sparse_matmul", (3, 2, 2))
    ...
    def test_3d_2d_sparse_single_contraction(self):
        ...
        assert_optimized_matmul(stres, res, "optimized_sparse_matmul", (3, 5))
    ...
    def test_2d_3d_sparse_single_contraction(self):
        ...
        assert_optimized_matmul(stres, res, "optimized_sparse_matmul", (5, 2))
    ...
    def test_3d_sparse_dense_double_contraction(self):
        ...
        assert_optimized_matmul(stres, res, "pure_dense_rhs", (3, 4, 2))
    ...
    def test_3d_dense_sparse_double_contraction(self):
        ...
        assert_optimized_matmul(stres, res, "pure_dense_rhs", (4, 3, 2))
    ...
    def test_3d_dense_sparse_double_contraction_2nd(self):
        ...
        assert_optimized_matmul(stres, res, "pure_dense_lhs", (3, 4, 5))
    ...
    def test_3d_double_dense_double_sparse_contraction(self):
        ...
        assert_optimized_matmul(stres, res, "optimized_sparse_matmul", (4, 3))
    ...
    def test_4d_dense_None_dense_sparse(self):
        ...
        stx = SparseTensor(
            [DenseDimension(0, 3, 0), SparseDimension(1, 4, None, 1)],
            [DenseDimension(2, 5, 1), SparseDimension(3, 4, None, 0)],
            x,
        )
        sty = SparseTensor(
    ...
    def test_4d_sparse_single_contraction(self):
        ...
        assert_optimized_matmul(stres, res, None, None)
    ...
    def test_4d_dense_double_contraction(self):
        ...
        assert_optimized_matmul(stres, res, "pure_dense_rhs", (5, 6, 2, 7))
    ...
    def test_4d_sparse_single_contraction_with_two_Nones(self):
        ...
        stx = SparseTensor(
            [SparseDimension(0, 3, None, 1), DenseDimension(1, 4, 0)],
            [SparseDimension(2, 3, None, 0), DenseDimension(3, 5, 1)],
            x,
        )
        sty = SparseTensor(
            [DenseDimension(0, 3, 0), SparseDimension(1, 5, None, 1)],
            [DenseDimension(2, 2, 1), SparseDimension(3, 5, None, 0)],
            y,
        )
        stres = stx @ sty
    ...
    def test_4d_sparse_dense_with_only_Nones(self):
        ...
        sty = SparseTensor(
            [SparseDimension(0, 3, None, 1), SparseDimension(1, 4, None, 0)],
    ...
    def test_4d_sparse_Nones(self):
        ...
        sty = SparseTensor(
            [SparseDimension(0, 3, 0, 1), SparseDimension(1, 4, None, 0)],
    ...
    def test_4d_double_sparse_single_sparse_Nones(self):
        ...
        stx = SparseTensor(
            [SparseDimension(0, 3, 0, 1), SparseDimension(1, 4, 1, 0)],
            [SparseDimension(2, 4, 1, 1), SparseDimension(3, 3, 0, 0)],
            x,
        )
        sty = SparseTensor(
            [SparseDimension(0, 4, None, 0), DenseDimension(1, 3, 0)],
            [SparseDimension(2, 4, None, 1), DenseDimension(3, 5, 1)],
            y,
        )
        stres = stx @ sty
    ...
    def test_4d_so_tired_of_it(self):
        ...
        sty = SparseTensor(
            [DenseDimension(0, 4, 0), SparseDimension(1, 3, None, 1)],
            [DenseDimension(2, 5, 1), SparseDimension(3, 3, None, 0)],
            y,
        )
        stres = stx @ sty
    ...
    def test_4d_dense_None_None_dense(self):
        ...
        stx = SparseTensor(
            [DenseDimension(0, 3, 0), SparseDimension(1, 5, None, 1)],
            [DenseDimension(2, 4, 1), SparseDimension(3, 5, None, 0)],
            x,
        )
        sty = SparseTensor(
            [SparseDimension(0, 4, None, 0), DenseDimension(1, 5, 0)],
            [SparseDimension(2, 4, None, 1), DenseDimension(3, 2, 1)],
            y,
        )
        stres = stx @ sty
    ...
    def test_3d_4d_sparse(self):
        ...
        assert_optimized_matmul(stres, res, "optimized_sparse_matmul", (4, 3, 5))
    ...
    def test_3d_4d_sparse_broadcast(self):
        ...
        assert_optimized_matmul(stres, res, "optimized_sparse_matmul", (2, 4, 4))
...
if __name__ == "__main__":
    ...
    def test_4d_sparse_single_contraction(self):
        ...
        assert_optimized_matmul(stres, res, "resolve_implicits", (3, 3))

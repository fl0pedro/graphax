...
from graphax.sparse.tensor import SparseDimension, SparseTensor
...
class TestSparseMul(unittest.TestCase):
    def test_simple_broadcast(self):
        ...
        iota = jnp.eye(4)
        assert_optimized_matmul(stres, res, "dense_fallback", (4, 4))
    ...
    def test_simple_Nones(self):
        ...
        assert_optimized_matmul(stres, res, "resolve_implicits", None)
    ...
    def test_4d_sparse_double_contraction(self):
        ...
        assert_optimized_matmul(stres, res, "dense_fallback", (3, 5, 3, 5))
